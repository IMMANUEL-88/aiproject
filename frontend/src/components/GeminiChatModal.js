// frontend/src/components/GeminiChatModal.js
...
const GeminiChatModal = ({ open, onClose, onSendMessage, messages, isLoading }) => {
    ...
    <Modal open={open} onClose={onClose}>
      <Box sx={style}>
        <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 2 }}>
          <Typography variant="h6" component="h2">Chat With AI (Gemini)</Typography>
